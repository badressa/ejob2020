...
<head>
    ...
    <link rel="stylesheet" href="maincss/propos.css?v=<?php echo time(); ?>">
...
echo "
    <div class='cvrbg-jb'>
        <div class='cvr-lr container-fluid ''> 
           <h1 class='cvr-h '>A propos de Joboor</h1>
           <h4 class='first-title ' > le premier site d'emploi au Maroc est dans votre service </h4>
...
?>
  ...
  <div class="container">
  	<div class="row" style="margin-top: 30px;">
       <div class="col-md-6 ">
         <h3 style="color: #154396; font-weight: bold;padding-left: 20px;">Apropos Jobdoor </h3>
         <p style=" font-size: 20px; text-align: justify-all;">Jobdoor est un site d'emploi, . jobdoor est actuellement disponible au maroc, 
...
<div class="col-md-6 ">
  <img src="images/website.jpg" style="width: 100%;">
</div>
</div>


         <form>
  <h4 class="mt-5 mb-3">Exprimer votre experience avec nous</h4>


  <div class="form-group">
    <textarea style="color: #6a99de; border-color: #6a99de;" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="ton avis"></textarea>
  </div>

   <div class="form-group mt-3" style="text-align: -webkit-center;">
    <input style="border-color: #c9515b;background-color: #154396; color: #fff; width: 100%;margin-bottom: 100px;" type="submit" value="envoyer" class="form-control" >
  </div>
</form>
